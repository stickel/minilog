class Post < ActiveRecord::Base
  ...
  named_scope :years, { :select => 'DATE_FORMAT(published_at,"%Y") AS year, permalink', :group => 'published_at' }
  named_scope :months, { :select => 'DATE_FORMAT(published_at,"%m") AS month, DATE_FORMAT(published_at,"%Y") AS year, permalink', :group => 'published_at' }
